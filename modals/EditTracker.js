...
class EditTrackerModal extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            name: '',
    ...
    componentDidUpdate = () => {
        if (this.state.justOpened && this.props.modalVisible) {
            this.setState({
                name: this.props.selectedTracker.name,
                icon: this.props.selectedTracker.icon ? this.props.selectedTracker.icon : icons[0],
                iconColor: this.props.selectedTracker.iconColor ? this.props.selectedTracker.iconColor : iconsColors[0],
                priority: this.props.selectedTracker.priority ? this.props.selectedTracker.priority : 1,
                unit:this.props.selectedTracker.unit,
                justOpened: false
            })
        }
    }
    ...
    save = async () => {
        ...
        let tracker = {
            id: this.props.selectedTracker.id,
            name: this.state.name,
            icon: this.state.icon,
            iconColor: this.state.iconColor,
            priority: this.state.priority,
            unit: this.state.unit,
            years:this.props.selectedTracker.years,
            latestValue:this.props.selectedTracker.latestValue
        }
            ...
            >
                <View style={{ backgroundColor: '#000000aa', width: Dimensions.get('screen').width, minHeight: Dimensions.get('screen').height }}>
                    ...
                    <View style={styles.nameView}>
                        ...
                        <Text style={styles.nameText}>Edit Tracker</Text>
